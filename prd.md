...
- MCP tools live: `create_product` (done in Phase 0 chunk 7), `list_products`, `update_product`, `delete_product`, `search_products`, `get_product`, `list_categories`, `create_category`, `update_category`, `delete_category`, `restore_category`, `hard_delete_expired_categories`
