...
**Phase 0 is complete.** Chunks 1–7, 9, 10, and 11 have all landed to `main` (chunk 11 closed 2026-04-23). Everything deployment-target-dependent (hosted CI pipeline, Coolify deploy webhook, Sentry DSN, Lighthouse enforcement, CDN, backups, uptime monitoring) was moved out of Phase 0 by the **2026-04-23 scope-split decision** and now lands as part of a new **Launch infrastructure** block at the top of Phase 1b in `prd.md` — that is the next block of work.
